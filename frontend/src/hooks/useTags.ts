 ...
 * requirement-react-custom-hooks.md Faz 2 Adim 2.2. useSchemalar'daki kalibi izler, TEK farkla:
 * useSchemalar mount'ta otomatik cekerken, burada BILEREK otomatik cekme YOK. Cunku mevcut
 ...
 * <p>
 * {@link getTagUsage} bilerek hook'a DAHIL DEGIL: "bir tag'i kullanan kolonlar" TaglerPanel'in
...
export function useTags() {
  ...
  return {
    ...
    renameTag: rename,
    deleteTag: remove,
    // useSchemalar'daki setSchemalarOptimistic ile ayni gerekce: Dashboard'daki tag silme de
