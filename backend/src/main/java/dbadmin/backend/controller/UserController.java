...
import dbadmin.backend.dto.ChangeRoleRequest;
import dbadmin.backend.dto.CreateUserRequest;
 ...
 * degil, {@code SecurityConfig}'te yol bazinda tanimlidir ({@code /api/users/**}).
 */
@RestController
...
public class UserController {
    ...
    @Operation(
            summary = "Tum kullanicilari sayfalanmis olarak listeler",
            description = "Parola hash'leri cevaba dahil edilmez. Standart Spring parametreleri "
                    + "gecerlidir: page, size, sort.")
    @GetMapping
