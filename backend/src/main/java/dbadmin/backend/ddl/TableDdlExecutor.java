...
public class TableDdlExecutor {
    ...
    /** Gercek {@code CREATE TABLE "isim" ("id" ..., "kolon1" tip1, ...)} calistirir; id kolonu her zaman otomatik eklenir. */
    public void createTable(String tableName, List<ColumnDefinition> columns) {
        ...
        jdbcTemplate.execute("CREATE TABLE " + quote(tableName) + " (" + ID_COLUMN_SQL + ", " + columnsSql + ")");
    }
